...
> **Status:** the app is built and deployed — sign-up through closing audit runs on real data, works offline, and is covered by 181 tests. What's not built is listed in [docs/ROADMAP.md](docs/ROADMAP.md).
...
181 tests, 679 assertions. Format PHP before committing:
