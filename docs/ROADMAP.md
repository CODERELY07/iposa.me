...
**Where things stand:** the product is built and deployed. Sign-up → menu → sell → closing audit → true daily profit works end to end, on real data, offline-capable, with 255 passing tests. What follows is what's *not* built, in the order that gets to the first paying shop fastest.
